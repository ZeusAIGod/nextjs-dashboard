            ...
            <div className='max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto flex flex-col w-full text-center justify-center'>
                ...
                <div className='grid grid-flow-row sm:grid-flow-col grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-12 py-8 lg:py-12 px-6 sm:px-0 lg:px-6'>
                    <ScrollAnimationWrapper className="flex justify-center">
                        <motion.div
                            variants={scrollAnimation}
                            className='flex flex-col justify-center items-center border-2 border-gray-300 rounded-xl py-4 px-6 lg:px-12 xl:px-20'
                            whileHover={{
                                scale: 1.1,
                                transition: {
                                    duraton: .2
                    ...
                    <ScrollAnimationWrapper>
                        <motion.h3
                            ...
                            className="text-2xl sm:text-3xl lg:text-4xl font-medium text-black-600 leading-relaxed w-9/12 sm:w-6/12 lg:w-4/12 mx-auto" >
                                Hug Global Network of Fast VPN
                        </motion.h3>
                        <motion.p 
                            className='leading-model mx-auto my-2 w-10/12 sm:w-7/12 lg:w-6/12'
                            variants={scrollAnimation}
                        >
                            See Our AI Team to make it easier for you when you move
                            locations.
                        </motion.p>
                    </ScrollAnimationWrapper>
                    <ScrollAnimationWrapper>
